...
func (a *API) handleGetCluster(w http.ResponseWriter, _ *http.Request) {
...
func (a *API) handleCreateJoinToken(w http.ResponseWriter, r *http.Request) {
...
func (a *API) handleClusterConnect(w http.ResponseWriter, r *http.Request) {
...
func (a *API) handleListMembers(w http.ResponseWriter, _ *http.Request) {
...
func (a *API) memberAuth(r *http.Request) (store.Member, bool) {
	raw := bearer(r)
	if raw == "" {
...
func (a *API) handleClusterSnapshot(w http.ResponseWriter, r *http.Request) {
	if a.cfg.Role != rolePrimary {
...
func (a *API) handleClusterSnapshotApply(w http.ResponseWriter, r *http.Request) {
	if a.cfg.Role != roleSecondary {
...
func (a *API) applySnapshot(snap store.Snapshot) error {
