...
const (
	...
	sessionCookie = "coredns_api_session"
	jwtTTL        = 12 * time.Hour
)
...
// API is the process-wide management plugin: HTTP mux + runtime zone owner.
type API struct {
	Next plugin.Handler
	cfg  coreConfig
	db   *store.Store
...
func (a *API) Name() string { return pluginName }
...
func (a *API) Transfer(zone string, serial uint32) (<-chan []dns.RR, error) {
