...
func (s *SecondaryPersist) lookupZone(qname string) (string, *file.Zone, bool) {
	s.zoneMu.RLock()
...
func (s *SecondaryPersist) zoneName(z *file.Zone) string {
	s.zoneMu.RLock()
	defer s.zoneMu.RUnlock()
...
func (s *SecondaryPersist) stopDynamicZones() {
	s.zoneMu.Lock()
